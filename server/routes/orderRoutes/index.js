...
const { createOrder, getAllOrders, getUserOrders, getOrderById, updateOrderStatus, deleteOrder } = require("../../controllers/orders");
const router = express.Router();

router.post("/order/add", tokenVerification, createOrder); // Create a new order (Authenticated User)
router.get("/order/get", tokenVerification, getAllOrders); // Get all orders (Admin Only)
