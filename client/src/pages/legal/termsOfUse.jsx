    ...
    <div className="w-full h-screen overflow-y-auto">
      ...
      <div className="bg-backgroundMain-light w-full text-colorText-light">
        ...
        <div className="container mx-auto xl:w-[1280px]">
          <div className="text-left pb-40 text-sm">
            <br />
            <p>
              Welcome to Ecommerce! By accessing or using our website, mobile
              app, or services (collectively referred to as the “Platform”), you
              agree to comply with and be bound by the following terms and
              conditions (the “Terms of Use”). These terms govern your use of
              Ecommerce, so please read them carefully. If you do not agree with
              these terms, you must discontinue using our Platform immediately.
            </p>
            <br />

            <ol className="list-inside list-decimal pl-5 space-y-4">
              {/* start of the List and points */}
              <li className="[&::marker]:font-bold">
                <strong className="text-base">OUR SERVICES</strong>
                <br />
                <br />
              ...
              <li className="[&::marker]:font-bold">
                ...
                <p>
                  ...
                  danishbansal60@gmail.com. If we ever grant you the permission
                ...
                <br />
                <p>
                  <strong>We may remove or edit your Content:</strong> Although
                ...
                <br />
                <h3 className="font-bold">Copyright infringement</h3>
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">USER REPRESENTATIONS</strong>
                <br />
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">USER REGISTRATION</strong>
                <br />
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">PRODUCTS</strong>
                <br />
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">PURCHASES AND PAYMENT</strong>
                <br />
                <br />
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">RETURN POLICY</strong>
                <br />
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">PROHIBITED ACTIVITIES</strong>
                <br />
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                ...
                <ol className="list-disc list-inside pl-5">
                  ...
                  <li>
                    ...
                    rights of any third party.Your Contributions do not violate
                    the privacy or publicity rights of any third party.Your
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">CONTRIBUTION LICENCE</strong>
                <br />
                <br />
                <p>
                  ...
                  Contributions, and grant and authorise sublicences of the
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">GUIDELINES FOR REVIEWS</strong>
                <br />
                <br />
                <p>
                ...
                <p>
                  ...
                  and licence to reproduce, modify, translate, transmit by any
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">SERVICES MANAGEMENT</strong>
                <br />
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">PRIVACY POLICY</strong>
                <br />
                <br />
                <p>
                  ...
                  Please be advised the Services are hosted in India. If you
                  ...
                  have your data transferred to and processed in India. Further,
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">COPYRIGHT INFRINGEMENTS</strong>
                <br />
                <br />
                <p>
                  We respect the intellectual property rights of others. If you
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">TERM AND TERMINATION</strong>
                <br />
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">GOVERNING LAW</strong>
                <br />
                <br />
                <p>
                  These Legal Terms shall be governed by and defined following
                  the laws of India. ECOMMERCE Corporation and yourself
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">DISPUTE RESOLUTION</strong>
                <br />
                <br />
                ...
                <p>
                  ...
                  informally for at least ten (10) days before initiating
                ...
                <p>
                  ...
                  Bathinda, India. The language of the proceedings shall be
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">CORRECTIONS</strong>
                <br />
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">LIMITATIONS OF LIABILITY</strong>
                <br />
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">INDEMNIFICATION</strong>
                <br />
                <br />
                <p>
                  ...
                  warranties set forth in these Legal Terms; (5) your violation
                  ...
                  via the Services. Notwithstanding the foregoing, we reserve
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">USER DATA</strong>
                <br />
                <br />
                <p>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">SMS TEXT MESSAGING</strong>
                <br />
                <br />
                <h3 className="font-bold">Opting Out</h3>
                <br />
                <p>
                ...
                <br />
                <h3 className="font-bold">Message and Data Rates</h3>
                <br />
                <p>
                ...
                <p>
                  ...
                  communications, please email us at danishbansal60@gmail.com or
                  call at +1 4379737783.
                </p>
              </li>
              ...
              <li className="[&::marker]:font-bold">
                <strong className="text-base">MISCELLANEOUS</strong>
                <br />
                <br />
                <p>
